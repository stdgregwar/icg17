...
class FrameBuffer {
    ...
    public:
        ...
        std::tuple<GLuint,GLuint> Init(int image_width, int image_height, bool use_interpolation = false) {
            ...
            // tie it all together
            {
                ...
                glFramebufferTexture2D(GL_FRAMEBUFFER, GL_DEPTH_ATTACHMENT,
                                          GL_TEXTURE_2D, depth_render_buffer_id_,0);
            ...
            return std::tie(color_texture_id_,framebuffer_object_id_);
        }
