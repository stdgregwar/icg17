...
class Cube {
    ...
    public:
        void Init(GLuint color_id, GLuint depth_id) {
            // compile the shaders.
            color_id_ = color_id;
            depth_id_ = depth_id;
            ...
            glUniform1i(glGetUniformLocation(program_id_,"frame_col"),1);
            glUniform1i(glGetUniformLocation(program_id_,"frame_depth"),2);
        ...
        void Draw(const glm::mat4& view_projection, const glm::mat4& view){
            glUseProgram(program_id_);
            glBindVertexArray(vertex_array_id_);
            ...
            glm::mat4 MV = view*model_matrix_;
            glUniformMatrix4fv(glGetUniformLocation(program_id_, "MV"),1,GL_FALSE, value_ptr(MV));
