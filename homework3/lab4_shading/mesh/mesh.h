...
class Mesh : public Material, public Light {
    ...
    private:
        void BindShader(GLuint program_id) {
            ...
            GLuint texture_1d_id = glGetUniformLocation(program_id, "tex1D");
            glUniform1i(texture_1d_id,0);
            // TODO 3.1 bind texture_2d_id_ for artistic shading
            GLuint art_tex_loc = glGetUniformLocation(program_id,"art_tex");
            glUniform1i(art_tex_loc,GL_TEXTURE1-GL_TEXTURE0);
        }
